...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
    ...
    {
        super ("sebrat","Pomocí tohoto příkazu vezme hráč věc a vloží ji do"
                + "batohu.");
    }
...
//\IM== INSTANCE REMAINING NON-PRIVATE METHODS =================================
    ...
    public String execute(String... arguments)
    {
        ...
        Thing object = currentProstory.getObject(objectName);
        if (object == null){
            return "zadali jste spatny tvar predmetu.";
        }
        Bag bag = Bag.getInstance();
        if (object.getWeight() >= bag.getCapacity()){
            return "tento predmet nelze sebrat.";
            }
        boolean added = bag.tryAddObject(object);
        if (added) {    
            currentProstory.removeObject(object);
            return "predmet " + objectName + " byl umisten do batohu.";
        }
        else {

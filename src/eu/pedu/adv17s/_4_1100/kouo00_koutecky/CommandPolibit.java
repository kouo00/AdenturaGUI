...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     */
    public CommandPolibit()
    {
        super ("polibit", "polibite blondynku");
    }
...
//\IM== INSTANCE REMAINING NON-PRIVATE METHODS =================================
    ...
    public String execute(String... arguments)
    {
        if (arguments.length <2) {
            return "neni co polibit";
        }
        if(!arguments[1].matches("zamilovana_blondynka"))   
            return ("toto libat nechces");
        Room postava = Potion.getInstance().getCurrentPlace();
        Thing zamilovana = postava.getObject("zamilovana_blondynka");
        if(zamilovana == null)
            return("zamilovana blondynka tu nenii :((");
        else {
        ACommand.stopGame();
        return("polibili jste zamilovanou blondynku.");
